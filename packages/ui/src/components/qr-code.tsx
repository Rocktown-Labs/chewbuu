...
/* oxlint-disable promise/prefer-await-to-callbacks, node/callback-return, unicorn/no-await-expression-member, react/no-danger, unicorn/prefer-dom-node-remove, react-hooks/exhaustive-deps -- third-party DiceUI QR component */

import { useLazyRef } from "@chewbuu/ui/hooks/use-lazy-ref";
import { useComposedRefs } from "@chewbuu/ui/lib/compose-refs";
  ...
  const store = React.useMemo<Store>(() => {
    return {
      ...
      setStates: (updates) => {
        ...
        for (const key of Object.keys(updates) as (keyof StoreState)[]) {
