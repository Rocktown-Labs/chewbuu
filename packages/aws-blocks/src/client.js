...
export const buildBlocksPlaceSearchTextQuery = __BLOCKS_ApiNamespaceClient__(
  "buildBlocksPlaceSearchTextQuery"
);
export const runDateLifecycle =
  __BLOCKS_ApiNamespaceClient__("runDateLifecycle");

export const generateClient = (config) => ({
  api: __BLOCKS_ApiNamespaceClient__("api", config),
  buildBlocksPlaceSearchTextQuery: __BLOCKS_ApiNamespaceClient__(
    "buildBlocksPlaceSearchTextQuery",
    config
  ),
  runDateLifecycle: __BLOCKS_ApiNamespaceClient__("runDateLifecycle", config),
});
